...
const config = {
  ...
  baseUrl: '/documentation/mamadou_elaphi.arafa/docusaurus/Meteo_Projet_React/',
  onBrokenLinks: 'throw',
  ...
  organizationName: 'mamadou_elaphi.arafa', // Usually your GitHub org/user name.
  projectName: 'Meteo_Projet_React', // Usually your repo name.
